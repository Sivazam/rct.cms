...
const sms_templates_js_1 = __importDefault(require("./lib/sms-templates.js"));
const sms_logs_js_1 = __importDefault(require("./lib/sms-logs.js"));
// Initialize Firebase Admin
admin.initializeApp();
// Firestore instance
const db = admin.firestore();
// Initialize SMS Logs Service with Firestore instance
const smsLogsService = sms_logs_js_1.default.getInstance(db);
...
function getTemplateIdByKey(templateKey) {
    const template = sms_templates_js_1.default.getInstance().getTemplateByKey(templateKey);
    if (!template) {
...
function formatVariablesForAPI(templateKey, variables) {
    return sms_templates_js_1.default.getInstance().formatVariablesForAPI(templateKey, variables);
}
/**
...
exports.retryFailedSMSV2 = functions
    ...
    try {
        ...
        const failedLogs = await sms_logs_js_1.default.getInstance().getFailedSMSLogs(maxRetryCount);
        ...
        for (const log of limitedLogs) {
            try {
                ...
                await sms_logs_js_1.default.getInstance().updateSMSLog(log.id, {
...
exports.getSMSStatisticsV2 = functions
    ...
    try {
        ...
        const stats = await sms_logs_js_1.default.getInstance().getSMSStatistics({
            dateRange,
            ...filters
        });
        ...
        return {
            ...
            serviceStatus: {
                isInitialized: true,
                templatesCount: sms_templates_js_1.default.getInstance().getAllTemplates().length,
